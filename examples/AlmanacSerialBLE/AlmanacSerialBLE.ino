...
Adafruit_SSD1351 oled0 = Adafruit_SSD1351(OLED_W, OLED_H, &SPI, CS_PIN_0, DC_PIN_0, RST_PIN_0);
Adafruit_SSD1351 oled1 = Adafruit_SSD1351(OLED_W, OLED_H, &SPI, CS_PIN_1, DC_PIN_1, RST_PIN_1);
...
/* // setup REAL TIME CLOCK
    if (! rtc.begin()) while (1);                               // wait until DS3231 RTC starts
...
*/
    ...
    // setup SSD1351 OLED RGB Displays
    ...
    oled0.setRotation(2);
    oled0.fillRect(0, 0, OLED_W, OLED_H, BLACK);
    delay(100);
    for(uint8_t c=0; c<8; c++) {
        oled0.fillRect(0, OLED_H * c / 8, OLED_W, OLED_H / 8,
        pgm_read_word(&colors[c]));
    }

    oled1.setRotation(2);
    oled1.fillRect(0, 0, OLED_W, OLED_H, BLACK);
    delay(100);
    for(uint8_t c=0; c<8; c++) {
        oled1.fillRect(0, OLED_H * c / 8, OLED_W, OLED_H / 8,
        pgm_read_word(&colors[c]));
    }
