// $Id: xxReconfigurable.hh 7631 2022-02-12 19:22:07Z flaterco $
...
private:
  ...
  xxReconfigurable (const xxReconfigurable &) = delete;
  xxReconfigurable &operator= (const xxReconfigurable &) = delete;
};
